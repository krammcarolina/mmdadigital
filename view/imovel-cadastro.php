<?php
require_once 'controller/_imovel-cadastro.php';
   ...
   <div id="rootwizard">
					<div class="navbar">
					  <div class="navbar-inner">
					    <div class="container">
					<ul>
					 	<li><a href="#tab1" data-toggle="tab">Dados do imóvel</a></li>
						<li><a href="#tab2" data-toggle="tab">Imagens</a></li>
						<li><a href="#tab3" data-toggle="tab">Dados do Anunciante</a></li>
					</ul>
					 </div>
					  </div>
					</div>
     
     <form class="bs-example bs-example-form" action="<?= $urlC."imovel-cadastro"?>" method="post" enctype="multipart/form-data">
    ...
    <div class="tab-pane" id="tab2">
      ...
      <div class="row">
        ...
        <div class="form-group col-lg-2">
          <input type="text" class="form-control phone" name="FRMtelefone[]" placeholder="Telefone" required  data-fv-notempty-message="Campo obrigatório"/>
        </div>
        
        <div class="form-group col-lg-1">
          <button type="button" class="btn btn-default col-lg-12" id="new_contact">+</button>
        </div> 
       
      </div>
      <div id="campos_contatos"></div>        
      
      <div style="float:right">
				    <input type='submit' class='btn btn-default btn-success' value='Finalizar' />
				  </div>        
    
    </div>
					
				<div style="float:right">
				  <input type='button' class='btn button-next' name='next' value='Próximo' />
				</div>
